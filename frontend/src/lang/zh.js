export default {
  ...
  components: {
    ...
    such_as_dataeasedataease: '请输入登录页面标题，比如：云数BI平台',
    for_example_dataease: '请输入系统名称，比如：云数BI平台',
  ...
  datasource: {
    ...
    auth_method: '认证方式',
    passwd: '用户名密码',
    kerbers_info: '请确保 krb5.Conf、Keytab Key，已经添加到路径：/opt/datacenter/conf',
  ...
  panel: {
    ...
    market_network_tips: '查看模板市场模板需要服务器与模板市场连通，请检查网络...',
  ...
  wizard: {
    ...
    contact_us: '联系我们',
    demo_video_hint: '如何3分钟制作一个BI数据看板、并分享给他人',
    online_document_hint: '涵盖BI的安装步骤、用户手册、使用教程、常见问题的解决方案、以及二次开发等',
    teaching_video_bottom_hint: '更多视频资料',
    enterprise_edition_hint1: '提供企业级应用场景X-Pack增强包',
    enterprise_edition_hint2: '提供高等级原厂服务支持',
    enterprise_edition_hint3: '提供BI最佳实践建议',
  ...
  app_template: {
    ...
    file_error_tips: '未找到相关数据文件，当前文件可能不是云数BI平台应用文件，或者文件已经损坏',
    app_export: '应用导出',
    app_version: '应用版本',
    program_version: '云数BI平台最低版本',
    creator: '作者',
    export: '导出'
  },

  logout: {
    oidc_logout_error: 'OIDC退出失败，是否继续退出云数BI平台？',
