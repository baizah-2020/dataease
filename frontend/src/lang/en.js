export default {
  ...
  components: {
    ...
    such_as_dataeasedataease: 'Please enter the login page title, such as: 云数BI平台',
    for_example_dataease: 'Please enter the system name, for example: 云数BI平台',
  ...
  datasource: {
    ...
    kerbers_info: 'Please make sure krb5 Conf, KeyTab key, added to path: /opt/datacenter/conf',
  ...
  panel: {
    ...
    market_network_tips: 'View template Market template requires server and template Market, please check the network... ',
  ...
  wizard: {
    welcome_title: 'Welcome Use 云数BI平台',
    ...
    demo_video_hint: 'How to make a BI dashboard in 3 minutes and share it with others',
    online_document_hint: 'It covers the installation steps, user manuals, tutorials, solutions to common problems, and secondary development of 云数BI平台',
    ...
    enterprise_edition_hint3: 'Provide BI best practice recommendations',
  ...
  app_template: {
    ...
    file_error_tips: 'The relevant data file is not found. The current file may not be a 云数BI平台 application file, or the file may be damaged ',
    app_export: 'Application export',
    app_version: 'Application version',
    program_version: '云数BI平台 minimum version',
    creator: 'Author',
    export: 'Export'
  },

  logout: {
    oidc_logout_error: 'OIDC failed to exit, do you continue to exit 云数BI平台?',
