export default {
  ...
  components: {
    ...
    such_as_dataeasedataease: '請輸入登入頁面標題，比如：云数BI平台',
    for_example_dataease: '請輸入系統名稱，比如：云数BI平台',
  ...
  datasource: {
    ...
    auth_method: '認證方式',
    passwd: '用戶名密碼',
    kerbers_info: '請確保 krb5.Conf、Keytab Key，已經添加到路徑：/opt/datacenter/conf',
  ...
  panel: {
    ...
    market_network_tips: '查看模板市場模板需要服務器與模板市場連通，請檢查網絡...',
  ...
  wizard: {
    ...
    contact_us: '聯繫我們',
    demo_video_hint: '如何3分鐘製作一個BI數據看闆、並分享給他人',
    online_document_hint: '涵蓋BI的安裝步驟、用戶手冊、使用教程、常見問題的解決方案、以及二次開發等',
    teaching_video_bottom_hint: '更多視頻資料',
    enterprise_edition_hint1: '提供企業級應用場景X-Pack增強包',
    enterprise_edition_hint2: '提供高等級原廠服務支持',
    enterprise_edition_hint3: '提供BI最佳實踐建議',
  ...
  app_template: {
    ...
    file_error_tips: '未找到相關數據文件，當前文件可能不是云数BI平台應用文件，或者文件已經損壞',
    app_export: '應用導出',
    app_version: '應用版本',
  ...
  logout: {
    oidc_logout_error: 'OIDC退出失敗，是否繼續退出云数BI平台？',
